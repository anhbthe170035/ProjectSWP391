...
public class DoctorListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<DoctorDetails> list = dao.getAllDoctors();
        ...
        if (departmentId != null && !departmentId.isEmpty()) {
            doctorList = dao.getDoctorsByDepartment(Integer.parseInt(departmentId));
        } else {
            doctorList = dao.getAllDoctors(); // Phương thức này sẽ lấy tất cả bác sĩ
        }
